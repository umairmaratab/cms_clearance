...
class StudentReport3(models.AbstractModel):
    _name = 'report.cms_student.report_template_3_id'
    _description = "Report"
    ...
    def _get_report_values(self, docids, data=None):
        ...
        return {
            ...
            'doc_model' : self.env['cms.clearance'],
            'data' : data,
            'docs' : self.env['cms.clearance'].browse(docids),
